...
estilo.configure("Vertical.TProgressbar", foreground ='black', background = 'black', troughcolor ='white',
    bordercolor = 'white', lightcolor = 'black', darkcolor = 'black')

frame0 = Frame (ventana, bg ='black', width=1900, height=850)
frame0.grid(column=0, row=0, sticky='nsew')

frame1 = Frame (ventana, bg ='white', width=1900, height=80)
frame1.grid(column=0, row=1, sticky='nsew')

frame2 = Frame (ventana, bg ='black', width=1900, height=50)
frame2.grid(column=0, row=2, sticky='nsew')

#barras extras para dar espacio desde el margen
barra101= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra101.grid(column = 0, row = 0, padx = 1)
barra102= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra102.grid(column = 1, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 3, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 4, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 5, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 6, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 7, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 8, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 9, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 10, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 11, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 12, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 13, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 14, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 15, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 16, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 17, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 18, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 19, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 20, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 21, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 22, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 23, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 24, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 25, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 26, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 27, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 28, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 29, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 30, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 31, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 32, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 33, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 34, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 35, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 36, row = 0, padx = 1)
barra103= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra103.grid(column = 37, row = 0, padx = 1)



#---------------------------------------------

barra1= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra1.grid(column = 43, row = 0, padx = 1)
barra2= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra2.grid(column = 44, row = 0, padx = 1)
barra3= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra3.grid(column = 45, row = 0, padx = 1)
barra4= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra4.grid(column = 46, row = 0, padx = 1)
barra5= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra5.grid(column = 47, row = 0, padx = 1)
barra6= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra6.grid(column = 48, row = 0, padx = 1)
barra7= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra7.grid(column = 49, row = 0, padx = 1)
barra8= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra8.grid(column = 50, row = 0, padx = 1)
barra9= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra9.grid(column = 51, row = 0, padx = 1)
barra10= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra10.grid(column = 52, row = 0, padx = 1)
barra11= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra11.grid(column = 53, row = 0, padx = 1)
barra12= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra12.grid(column = 54, row = 0, padx = 1)
barra13= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra13.grid(column = 55, row = 0, padx = 1)
barra14= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra14.grid(column = 56, row = 0, padx = 1)
barra15= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra15.grid(column = 57, row = 0, padx = 1)
barra16= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra16.grid(column = 58, row = 0, padx = 1)
barra17= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra17.grid(column = 59, row = 0, padx = 1)
barra18= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra18.grid(column = 60, row = 0, padx = 1)
barra19= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra19.grid(column = 61, row = 0, padx = 1)
barra20= ttk.Progressbar(frame1, orient='vertical', length=100, maximum=100, style="Vertical.TProgressbar")
barra20.grid(column = 62, row = 0, padx = 1)
...
estilo1.configure("Horizontal.TProgressbar", foreground='red', background ='white', troughcolor='DarkOrchid1',
                                                                bordercolor ='#970BD9', lightcolor='#970BD9', darkcolor='white')
...
imagenOjos = PhotoImage( file = '/home/tb2/o.png')
...
style = ttk.Style()
style.configure('Horizontal.TScale',bordercolor='green2', troughcolor='white', background='green2', foreground='green2',
    lightcolor='green2', darkcolor='white')
...
def nexusTexto():    
        ...
        if (variable!="N0"):
            if (numeroPalabras >25):
                ...
                respuestaChatBot = "La respuesta debe tener al menos 200 palabras, por favor repita"
                print("audio que envia a grabar "+respuestaChatBot)
                myobj = gTTS(text=respuestaChatBot, lang=language, slow=False)
